...
and copy the lib\ tree to your Perl top level directory (e.g. c:\perl).  

**BE CAREFUL NOT TO CLOBBER YOUR PERL LIB TREE!**

Then, simply move ApacheModulePerl.dll to the modules directory under your 
...
There is a known problem using mod_perl with Apache on Windows NT and MSIE
3.x clients.  Specifically, the Apache server will crash when an MSIE
client requests any document handled by mod_perl.  A bug report has been
opened with the Apache group (pr#1729).

The workaround for this problem is to comment or delete this line from your
srm.conf:

BrowserMatch Mozilla/2 nokeepalive

(FYI: MSIE reports itself as Mozilla/2 (compatible; MSIE 3.0...))
